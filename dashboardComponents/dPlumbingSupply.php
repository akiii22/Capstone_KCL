...
<section class="products">
   ...
   <input type="text" name="searchProduct" placeholder="Search for plumbing products with the name" id="searchProduct" class="searchProductPlumbing">
   ...
   <?php 
      $select_products = $conn->prepare("SELECT * FROM `products` WHERE product_specs='Plumbing'");
