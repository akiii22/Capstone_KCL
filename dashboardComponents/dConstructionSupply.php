...
<section class="products">
   ...
   <input type="text" name="searchProductCS" placeholder="Search for construction supply products with the name" id="searchProduct" class="searchProductCS">

   </span>


   <div class="box-container CS">

   <?php 
      $select_products = $conn->prepare("SELECT * FROM `products` WHERE product_specs='Construction'");
