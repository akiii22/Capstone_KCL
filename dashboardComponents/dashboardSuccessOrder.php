...
session_start();
$orderQuery = mysqli_query($conn2,"SELECT * FROM orders WHERE status='delivered'");
...
<body>
    ...
    <a style="color:grey;text-decoration:none;font-size:1.3rem;margin-left:1rem;" href="dashboardOngoingOrder.php">On
        Going Orders</a>
    <a style="color:red;text-decoration:none;font-size:1.3rem;margin-left:1rem;"
        href="dashboardCancelOrder.php">Canceled Order</a>
    <a style="color:green;text-decoration:none;font-size:1.3rem;margin-left:1rem;border-bottom:2px solid grey;"
