$(document).ready(()=>{
  ...
  $('.submitRegister').on('click',()=>{
      ...
      let selectRegister = $('#selectRegister');
          ...
          // validate
          if(nameRegister.val()===""||usernameRegister.val()===""||passRegister.val()===""|| confirmPassRegister.val()==""||addressRegister.val()==""||numberRegister.val()==""||secretKey.val()==""||selectRegister.val()===""){
              // blank
          ...
          }else if(passRegister.val().length > 29 || passRegister.val().length <6){
