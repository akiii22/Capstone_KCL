...
session_start();
$orderQuery = mysqli_query($conn2,"SELECT * FROM orders WHERE status='canceled'");
...
<body>
    ...
    <form id="signoutCon" action="" method="POST">

        <button name="signoutDeliver" class="Btn signoutDeliver">
    ...
    <h1>Cancel's Order</h1>
    <a style="color:grey;text-decoration:none;font-size:1.3rem;margin-left:1rem;" href="dashboardOrder.php">Orders</a>
    <a style="color:grey;text-decoration:none;font-size:1.3rem;margin-left:1rem;" href="dashboardOngoingOrder.php">On
        Going Orders</a>
    <a style="color:red;text-decoration:none;font-size:1.3rem;margin-left:1rem;border-bottom:2px solid grey;"
        href="dashboardCancelOrder.php">Canceled Order</a>
    <a style="color:green;text-decoration:none;font-size:1.3rem;margin-left:1rem;"
        href="dashboardSuccessOrder.php">Success Order</a>
